...
const Navbar = (props:{walletOnClick:() => Promise<void>, buyOnClick: () => void, connected:boolean}) => {
    ...
    function navThemeSwitch() {
        ...
        return theme === "dark" ? darkIconData : lightIconData
    }
    ...
    return (
        <Panel panelType='nav' additionalClasses={styles.panelCtn}>

            <div className={styles.leftContentCtn}>
                <NavbarLogo />
                <div className={styles.leftContentItemsCtn}>
                   {MainLinks}
                </div>
            </div>

            <div className={styles.rightContentCtn}>

                <div className={styles.rightContentItemsCtn}>

                    <div className={styles.themeBtnCtn} onClick={() => toggleTheme()}>
                        <SvgIcon
                ...
                <div className={styles.rightContentButtonCtn}>
                    <WalletButton
                        clickable={!props.connected}
                        active={!props.connected}
                        onClickFunction={props.walletOnClick}
                    />
                </div>
