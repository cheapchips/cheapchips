...
const TransactionModal = (props:{txTitle:string, onClickClose:() => void}) => {
    ...
    const CreatedTx = () => {
        ...
        <>
            ...
            <span className={styles.text}>Please confirm the transaction in Metamask!</span>
        </>
        )
    }
    ...
    const SubmittedTx = () => {
        return (
            <>
                ...
                />
                <span className={styles.text}>Processing transaction...</span>
            </>
        )
    }
    ...
    const DeniedTx = () => {
        return (
            <>
                ...
                />
                <span className={styles.text}>You denied the transaction.</span>
            </>
        )
    ...
    const FailedTx = () => {
        return (
            <>
                ...
                <span className={styles.text + styles.textErr}>Error: {(!web3.tx.errorMessage) ? "" : web3.tx.errorMessage}</span>
            </>
        )
    }
